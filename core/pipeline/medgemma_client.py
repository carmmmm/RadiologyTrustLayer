...
_MOCK_CHF = {
    ...
    "rewrite": {
        "rewrites": [
            ...
            {"claim_id": "c3", "original": "Bilateral pleural effusions are suspected, right greater than left.", "suggested": "Verify with radiologist — this finding could not be confirmed from the image.", "reason": "Only the right costophrenic angle shows clear blunting; bilateral effusion is not convincingly demonstrated and requires radiologist verification."},
            {"claim_id": "c5", "original": "The pulmonary vasculature appears engorged, consistent with pulmonary venous hypertension.", "suggested": "Verify with radiologist — this finding could not be confirmed from the image.", "reason": "Pulmonary venous hypertension is a strong clinical claim that exceeds the subtle imaging findings visible here."},
        ],
